            ...
            {
                {
                    MyLanguagesEnum.English, new Dictionary<string, string>
                    {
                        ...
                        { $"WeaponInfoAutoGenerated", "Weapon Definition is Automatically Generated. Weapon performance will differ from what the mod developer intended." },
                        { $"WeaponAutoConvertDesc", "Weapon automattically converted to WC from vanilla! Weapon performance will differ from what the mod developer intended, and any custom non-vanilla based stats are not transferred.\n\n" },
                    }
                },
               {
